...
path.to.public.key <- "~/Dropbox (Personal)/School/52414/Lectures_2018/course_data/pub_cyphr_52414"
...
```{r}
rmd.path.name.input <- "~/Dropbox (Personal)/School/52414/testing_encryption.Rmd"
rmd.path.name.output <- "~/Dropbox (Personal)/School/52414/testing_encryption_ENCYPTED"
