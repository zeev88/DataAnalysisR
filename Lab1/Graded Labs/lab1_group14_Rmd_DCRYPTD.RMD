...
```
```{}
You didn't manually joined the town names to crimes.full
```
...
```
```{}
This code fails to run- you didn't define well total.assault.rate. 
Also, this is not how we usually plot dataframes - please see solutions. 
```
